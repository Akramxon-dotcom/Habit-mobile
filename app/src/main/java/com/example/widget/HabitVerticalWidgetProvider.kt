...
class HabitVerticalWidgetProvider : AppWidgetProvider() {

    override fun onUpdate(context: Context, appWidgetManager: AppWidgetManager, appWidgetIds: IntArray) {
        for (appWidgetId in appWidgetIds) {
            updateVerticalWidget(context, appWidgetManager, appWidgetId)
        }
    }
    ...
    companion object {
        fun updateAllWidgets(context: Context) {
            ...
            val thisWidget = ComponentName(context, HabitVerticalWidgetProvider::class.java)
            val allWidgetIds = appWidgetManager.getAppWidgetIds(thisWidget)
            for (id in allWidgetIds) {
                updateVerticalWidget(context, appWidgetManager, id)
            }
        }

        fun updateVerticalWidget(context: Context, appWidgetManager: AppWidgetManager, appWidgetId: Int) {
            ...
            val views = RemoteViews(context.packageName, R.layout.widget_habit_vertical)
